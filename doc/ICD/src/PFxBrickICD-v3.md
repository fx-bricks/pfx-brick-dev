...
\begin{tabular}{ | c | p{13.8cm} | }
  ...
  Rev & Change Notes  \\
  \hline
  2.1  & The \footnotesize PFX\_CMD\_GET\_ICD\_REV \normalsize message was added so that firmware can report which revision of ICD it conforms with. \\
       & The \footnotesize COMMAND\_IR\_LOCKOUT\_TOGGLE \normalsize command was added to the \footnotesize COMMAND \normalsize byte of event/action definition. \\
       & The \footnotesize MOTOR\_ACTION\_ID \normalsize definitions for \footnotesize MOTOR\_STOP \normalsize and \footnotesize MOTOR\_COAST \normalsize were redefined to \footnotesize MOTOR\_ESTOP \normalsize and \footnotesize MOTOR\_STOP \normalsize respectively. \\
       & New PFX settings bit added to the PFx Brick configuration called Audio DRC. \\
       & The \footnotesize PFX\_CMD\_WRITE\_SN \normalsize and \footnotesize PFX\_CMD\_READ\_SN \normalsize messages were added to manage PFx Brick serial number assignment. \\
  \hline
  2.2  & Added description for the traffic light combo light f/x. \\
  \hline
  2.3  & Added new message \footnotesize PFX\_CMD\_GET\_CURRENT\_STATE \normalsize to report internal operating state of motors, lights, audio, etc. \\
  \hline
  2.4  & Modified the format of the \footnotesize PFX\_CMD\_GET\_CURRENT\_STATE \normalsize message to report motor PWM speed. \\
       &  Corrected the numeric definitions of \footnotesize BAR\_STYLE \normalsize used with the sound bar light f/x. \\
  \hline
  2.5  & Added new message \footnotesize PFX\_CMD\_GET\_IRRX\_STATUS \normalsize message to report low level data from the IR receiver processor. \\
  \hline
  2.6  & Added new message \footnotesize PFX\_CMD\_SET\_AUDIO\_EQ \normalsize message to set audio equalization levels.  The valid range for bass/treble EQ values has been set to -20 to +20 dB in the configuration. \\
       & Modified the \footnotesize PFX\_CMD\_GET\_CURRENT\_STATE \normalsize message format to send the internal millisecond counter data. \\
  \hline
  2.7  & Added new parameter \footnotesize SWEEP\_STYLE \normalsize for the \footnotesize COMBOFX\_LINEAR\_SWEEP \normalsize and \footnotesize COMBOFX\_BARGRAPH\_SWEEP \normalsize combination light f/x. \\
  \hline
  2.8  & Added new \footnotesize MOTOR\_STEP \normalsize parameter for Lego compatible 7 step operation. \\
       & Added new \footnotesize COMBOFX\_LAVA\_LAMP \normalsize combo light f/x \\
       & Added new \footnotesize WHELEN\_STYLE \normalsize parameter for a random program of flashing sequences. \\
  \hline
...
\begin{tabular}{ | c | p{13.8cm} | }
  ...
  Rev & Change Notes  \\
  \hline
  3.0  & Revised the \footnotesize PFX\_CMD\_GET\_STATUS \normalsize message to include comprehensive product identification.  This includes a new fields for USB PID, Product Number, Product Descriptor, a new 4-byte Serial Number, and a new 2-byte Firmware Version. \\
       & Deprecated the Product ID, Hardware Version, Firmware Version, and Serial Number fields in the the \footnotesize PFX\_CMD\_GET\_CONFIG \normalsize message. \\ 
       & Revised the \footnotesize PFX\_CMD\_WRITE\_SN \normalsize and \footnotesize PFX\_CMD\_READ\_SN \normalsize messages to accommodate the new 4-byte serial number format. \\
       & Added new \footnotesize COMMAND \normalsize bytes to the event/action LUT. \\
       & Renamed \footnotesize EVT\_DEFAULT\_EVENT \normalsize to \footnotesize EVT\_STARTUP\_EVENT1 \normalsize and added 3 more startup events. \\
  \hline
  3.1  & Revised the \footnotesize PFX\_CMD\_GET\_ICD\_REV \normalsize message to support a 2-byte revision numbering scheme. \\
  \hline
  3.11 & Added a new \footnotesize RETRIGGER \normalsize parameter to the \footnotesize SOUNDFX\_PLAY\_ONCE \normalsize sound f/x. \\
       & Added new \footnotesize COMBOFX\_LASER\_CANNON \normalsize combination light f/x. \\  
       & Corrected the description of \footnotesize EVT\_STARTUP\_EVENTx \normalsize for both the \footnotesize PFX\_CMD\_GET\_EVENT\_ACTION, PFX\_CMD\_SET\_EVENT\_ACTION \normalsize messages. \\
  \hline
  3.12 & Changed the format of the \footnotesize PFX\_CMD\_GET\_AUDIO\_LUT\_ENTRY \normalsize message to also return the start address of the audio sample data. The File Size field now represents the Data Size of audio sample data, not the total file size.  These changes reflect internal changes in the firmware to be tolerant of different WAV file formats including LIST and INFO chunks. \\
       & Changed the format of the \footnotesize PFX\_CMD\_ADD\_AUDIO\_DATA \normalsize message to report progress information for lengthy flash erase operations which result in a \footnotesize PFX\_ERR\_TRANSFER\_BUSY\_WAIT \normalsize status response code. \\
  \hline
  3.13 & Added suggested default values for all of the light f/x. \\       
  \hline
  3.14 & Added new \footnotesize LIGHTFX\_BROKEN\_LIGHT \normalsize single light f/x. \\
       & Added new \footnotesize LIGHTFX\_STATUS\_INDICATOR \normalsize single light f/x. \\
       & Revised the definition of the light output 7 for emergency flashers from solid to 2x flasher. \\ 
       & Added a Silent flag for the \footnotesize PFX\_CMD\_GET\_ICD\_REV \normalsize message so that it can be used for covert connection monitoring. \\
  \hline
  3.15 & Added new \footnotesize LIGHTFX\_SOUND\_MODULATED \normalsize single light f/x. \\
       & Added new \footnotesize FLICKER\_ON \normalsize parameter to \footnotesize LIGHTFX\_ON\_OFF\_TOGGLE \normalsize light f/x. \\
       & Added new definition to \footnotesize LIGHT\_PARAM4 \normalsize for single light f/x to assert output state beyond simple toggle on/off. \\
       & Increased the audio LUT size from 16 to 32 entries. \\
  \hline
  3.16 & Added new \footnotesize LIGHTFX\_MOTOR\_MODULATED \normalsize single light f/x. \\
       & Corrected the parameter definition for \footnotesize LIGHTFX\_SCIFI\_ENGINE\_GLOW \normalsize \\
  \hline
\end{tabular}
...
\begin{tabular}{ | c | p{13.8cm} | }
  ...
  Rev & Change Notes  \\
  \hline
  3.17 & Added new \footnotesize COMMAND\_RESTART \normalsize command \\
       & Added additional response data to the \footnotesize PFX\_CMD\_GET\_CURRENT\_STATE \normalsize command \\
  ...
  3.20  & Updated the memory map to show the addition a File Allocation Table file system and removal of the Audio LUT structure. \\
        ...
        & Deprecated the following messages associated with audio file access: \footnotesize PFX\_CMD\_ADD\_AUDIO\_FILE, PFX\_CMD\_ADD\_AUDIO\_DATA, PFX\_CMD\_ADD\_AUDIO\_DONE, PFX\_CMD\_GET\_AUDIO\_FILE, PFX\_CMD\_GET\_AUDIO\_DATA, PFX\_CMD\_ERASE\_AUDIO\_LUT \normalsize \\
        & Added an error code reference for file system access commands \\
        & Deprecated the \footnotesize PFX\_CMD\_DIAG\_LED \normalsize command \\
        & Changed the command byte value of \footnotesize PFX\_CMD\_GET\_ICD\_REV \normalsize to 0x08 from 0x00 since 0x00 seems to be a reserved report byte usage value for USB HID report packets \\
        & Changed the format of the configuration data in \footnotesize PFX\_CMD\_SET\_CONFIG \normalsize and \footnotesize PFX\_CMD\_GET\_CONFIG \normalsize to support optional individual brightness adjustments for each lighting channel. \\
        & Changed the format of the \footnotesize PFX\_CMD\_GET\_STATUS \normalsize message to include new fields for USB VID and firmware build no. \\
  \hline
  3.21  & Changed the \footnotesize PFX\_CMD\_FILE\_FORMAT\_FS \normalsize message to specify different formatting modes. \\
        & Added a new request to the \footnotesize PFX\_CMD\_FILE\_DIR \normalsize command. \\
        & Changed the \footnotesize PFX\_CMD\_GET\_CURRENT\_STATE \normalsize message to add more status parameters. \\
  \hline
  3.22  & Changed the \footnotesize PFX\_CMD\_FILE\_GET\_FS\_STATE \normalsize message to report both free and empty sectors. \\
  \hline
  3.23  & Added an \footnotesize INVERT \normalsize parameter to \footnotesize LIGHTFX\_SOUND\_MODULATED \normalsize single light effect. \\
  \hline
  3.24  & Changed product ID and corresponding descriptors.  Added product ID reference table as an appendix. \\
        & Added new motor actions \footnotesize MOTOR\_SET\_SPD\_TIMED, MOTOR\_OSCILLATE, MOTOR\_OSCILLATE\_BIDIR, MOTOR\_OSCILLATE\_BIDIR\_WAIT, MOTOR\_RANDOM, MOTOR\_RANDOM\_BIDIR, MOTOR\_SOUND\_MODULATED  \normalsize \\
        & Added new motor parameters \footnotesize DURATION \normalsize and \footnotesize MOTOR\_PERIOD \normalsize \\
        & Extended the definition of the \footnotesize MOTOR\_SPEED \normalsize parameter to allow for higher resolution set speed. \\
...
\begin{tabular}{ | c | p{13.8cm} | }
  ...
  Rev & Change Notes  \\
  \hline
  3.25  & Added new Bluetooth communications commands \footnotesize PFX\_CMD\_GET\_BT\_STATUS, PFX\_CMD\_SET\_BT\_POWER, PFX\_CMD\_SEND\_BT\_UART, PFX\_CMD\_RECEIVE\_BT\_UART \normalsize  \\
  \hline
  3.30  & Changed the format of the configuration data in \footnotesize PFX\_CMD\_SET\_CONFIG \normalsize and \footnotesize PFX\_CMD\_GET\_CONFIG \normalsize to support new parameters. \\
        & Specification of the user-defined name has been moved from the configuration messages to two new messages: \footnotesize PFX\_CMD\_SET\_NAME \normalsize and \footnotesize PFX\_CMD\_GET\_NAME \normalsize \\
  ...
  \hline
  3.31  & Added a new command \footnotesize PFX\_CMD\_SEND\_EVENT \normalsize to simulate remote control events over USB or BLE. \\
        & Expanded the definition of the \footnotesize MOTOR\_PERIOD \normalsize  parameter to specify both an ON and OFF duration. \\
  \hline
  3.32  & Added the notificaiton mechanism to allow USB and BLE connected hosts to subscribe to notifications from the PFx Brick. This adds the \footnotesize PFX\_CMD\_SET\_NOTIFICATIONS \normalsize and \footnotesize PFX\_MSG\_NOTIFICATION \normalsize commands to the host control interface. \\
  \hline
  3.33  & Added new \footnotesize SOUND\_FX\_ID:  SOUND\_FX\_PLAY\_IDX\_MOTOR \normalsize for realistic motor/prime mover sound effects based on sampled sound files indexed by changes in motor speed. \\
        & Added new new \footnotesize SOUND\_FX\_ID:  SOUND\_FX\_PLAY\_RAND \normalsize to randomly playback a specified sound file continuously. \\
        & Changed the format of the configuration data in \footnotesize PFX\_CMD\_SET\_CONFIG \normalsize and \footnotesize PFX\_CMD\_GET\_CONFIG \normalsize to store speed boundaries between indexed motor speed sounds. \\ 
        & Added new \footnotesize TRAFFIC\_STYLE \normalsize type "European 2". \\
  \hline
  3.34  & Added new \footnotesize TRAFFIC\_STYLE \normalsize type "European 2 with pedestrian crossing" \\
        & Changed the format of the \footnotesize PFX\_CMD\_GET\_CURRENT\_STATE \normalsize return message \\
        & Added new items to the \footnotesize SOURCE1 \normalsize parameter \\
        & Deprecated the namespace prefix of \footnotesize PFX\_USB\_CMD\_ \normalsize and replaced it with the more appropriate \footnotesize PFX\_CMD\_ \normalsize prefix. All references to either namespace are considered synonymous. \\
        & Changed the format of the \footnotesize PFX\_CMD\_FILE\_DIR \normalsize response message to include the request type in the response to simplify parsing by the host. \\
  \hline
  3.35  & Deprecated the \footnotesize PFX\_CMD\_GET\_AUDIO\_LUT\_ENTRY, PFX\_CMD\_GET\_AUDIO\_CAPACITY \normalsize messages \\
        & Added new \footnotesize PFX\_CMD\_FILE\_DIR \normalsize request type \footnotesize PFX\_DIR\_REQ\_SET\_ATTR\_MASKED\_ID \normalsize \\
...
\begin{tabular}{ | c | p{13.8cm} | }
  ...
  Rev & Change Notes  \\
  \hline
  3.36  & Changed the \footnotesize SOUNDFX\_STOP \normalsize definition to stop audio playback of the file specified in \footnotesize SOUND\_FILE\_ID \normalsize rather than all audio playback. \\
        & Deprecated the \footnotesize PFX\_CMD\_GET\_LAST\_IR\_MSG, PFX\_CMD\_VERIFY\_CONFIG, PFX\_CMD\_VERIFY\_EVENT\_LUT \normalsize messages \\
        & Added new error code \footnotesize PFX\_ERR\_TRAP\_BROWNOUT\_RST \normalsize \\
        & Corrected the \footnotesize PFX\_CMD\_READ\_I2C, PFX\_CMD\_WRITE\_I2C \normalsize messages description to conform with actual firmware implementation. \\
...
\begin{bytefield}[bitwidth=\widthof{SECTIM~},endianness=little]{10}
  \bitheader{0-9} \\
...
\begin{bytefield}[bitwidth=\widthof{SECTIM~},endianness=little]{4}
  \bitheader[lsb=20]{20-23} \\
  \bitbox{4}{CRC32[31:0]} \\
\end{bytefield}

\begin{bytefield}[bitwidth=\widthof{MIM~},endianness=little]{16}
...
The user defined bits of `User Attributes` can be used by the host application and firmware in any agreed upon way. Currently, for the storage of audio WAV files the `User Attributes[7:0]` bits have the following definitions:
...
\begin{tabular}{ | l | p{8cm} | }
  ...
  Command & Definition   \\
  \hline
  PFX\_CMD\_FILE\_OPEN      & Open virtual file handle                                                             \\
  PFX\_CMD\_FILE\_CLOSE     & Close file handle                                                                    \\
  PFX\_CMD\_FILE\_READ      & Read data from file to host                                                          \\
  PFX\_CMD\_FILE\_WRITE     & Write host data to file                                                              \\
  PFX\_CMD\_FILE\_SEEK      & Move file pointer to a specified byte offset with respect to the beginning of a file \\
  PFX\_CMD\_FILE\_DIR       & Query the file system for directory information or make changes to directory data   \\
  PFX\_CMD\_FILE\_REMOVE    & Remove a file from the file system  \\
  PFX\_CMD\_FILE\_FORMAT\_FS & Erase all files and reinitialize the file system directory and file allocation table \\
  PFX\_CMD\_FILE\_GET\_FS\_STATE & Reports low-level status information on the file system \\
  \hline
\end{tabular}
\normalsize
...
\begin{tabular}{ | c | c | l | }
  ...
  \hline
  0x00-0x03 & 0x00 & EVT\_8879\_TWO\_BUTTONS  \\
  0x04-0x07 & 0x01 & EVT\_8879\_LEFT\_BUTTON  \\
  0x08-0x0B & 0x02 & EVT\_8879\_RIGHT\_BUTTON \\
  0x0C-0x0F & 0x03 & EVT\_8879\_LEFT\_INC     \\
  0x10-0x13 & 0x04 & EVT\_8879\_LEFT\_DEC     \\
  0x14-0x17 & 0x05 & EVT\_8879\_RIGHT\_INC    \\
  0x18-0x1B & 0x06 & EVT\_8879\_RIGHT\_DEC    \\
  0x1C-0x1F & 0x07 & EVT\_8885\_LEFT\_FWD     \\
  0x20-0x23 & 0x08 & EVT\_8885\_LEFT\_REV     \\
  0x24-0x27 & 0x09 & EVT\_8885\_RIGHT\_FWD    \\
  0x28-0x2B & 0x0A & EVT\_8885\_RIGHT\_REV    \\
  0x2C-0x2F & 0x0B & EVT\_8885\_LEFT\_CTROFF  \\
  0x30-0x33 & 0x0C & EVT\_8885\_RIGHT\_CTROFF  \\
  0x34-0x37 & 0x0D & EVT\_EV3\_BEACON \\
  \hline
\end{tabular}  
...
\begin{tabular}{ | c | c | l | p{6.5cm} | }
  ...
  \hline
  0x38 & 0x0E & EVT\_TEST\_EVENT      & Used for testing actions sent by a USB connected host \\
  0x3C & 0x0F & EVT\_STARTUP\_EVENT1  & Used for storing start-up actions performed after power on \\
  0x3D & 0x0F & EVT\_STARTUP\_EVENT2  &   \\
  0x3E & 0x0F & EVT\_STARTUP\_EVENT3  &   \\
  0x3F & 0x0F & EVT\_STARTUP\_EVENT4  &   \\
  0x40 & 0x10 & EVT\_STARTUP\_EVENT5  &   \\
  0x41 & 0x10 & EVT\_STARTUP\_EVENT6  &   \\
  0x42 & 0x10 & EVT\_STARTUP\_EVENT7  &   \\
  0x43 & 0x10 & EVT\_STARTUP\_EVENT8  &   \\
  \hline
\end{tabular}
\medskip
...
\begin{tabular}{ | c | c | l | }
  ...
  Address & Event ID & MNEMONIC \\
  \hline
  0x50-0x53 & 0x14 & EVT\_RCTRAIN\_UP   \\
  0x54-0x57 & 0x15 & EVT\_RCTRAIN\_DOWN \\
  0x58-0x5B & 0x16 & EVT\_RCTRAIN\_STOP  \\
  0x5C-0x5F & 0x17 & EVT\_RCTRAIN\_HORN   \\
  \hline
\end{tabular}
\medskip
...
\begin{tabular}{ | c | c | c | l |  }
  ...
  \hline
  0x60 & 0x18 & 0 & EVT\_SPARKFUN\_POWER \\
  0x61 & 0x18 & 1 & EVT\_SPARKFUN\_A \\
  0x62 & 0x18 & 2 & EVT\_SPARKFUN\_B \\
  0x63 & 0x18 & 3 & EVT\_SPARKFUN\_C \\
  0x64 & 0x19 & 0 & EVT\_SPARKFUN\_UP \\
  0x65 & 0x19 & 1 & EVT\_SPARKFUN\_DOWN \\
  0x66 & 0x19 & 2 & EVT\_SPARKFUN\_LEFT \\
  0x67 & 0x19 & 3 & EVT\_SPARKFUN\_RIGHT \\
  \hline
\end{tabular}
\medskip
...
\begin{tabular}{ | c | c | c | l |  }
  ...
  Address & Event ID & Ch & MNEMONIC \\
  \hline
  0x68 & 0x1A & 0 & EVT\_ADAFRUIT\_VOLDOWN \\ 
  0x69 & 0x1A & 1 & EVT\_ADAFRUIT\_PLAY \\  
  0x6A & 0x1A & 2 & EVT\_ADAFRUIT\_VOLUP \\ 
  0x6B & 0x1A & 3 & EVT\_ADAFRUIT\_SETUP \\ 
  0x6C & 0x1B & 0 & EVT\_ADAFRUIT\_STOP \\  
  0x6D & 0x1B & 1 & EVT\_ADAFRUIT\_UP \\    
  0x6E & 0x1B & 2 & EVT\_ADAFRUIT\_DOWN \\  
  0x6F & 0x1B & 3 & EVT\_ADAFRUIT\_LEFT \\  
  0x70 & 0x1C & 0 & EVT\_ADAFRUIT\_RIGHT \\ 
  0x71 & 0x1C & 1 & EVT\_ADAFRUIT\_ENTER \\ 
  0x72 & 0x1C & 2 & EVT\_ADAFRUIT\_REPEAT \\
  0x73 & 0x1C & 3 & EVT\_ADAFRUIT\_0 \\     
  0x74 & 0x1D & 0 & EVT\_ADAFRUIT\_1 \\     
  0x75 & 0x1D & 1 & EVT\_ADAFRUIT\_2 \\     
  0x76 & 0x1D & 2 & EVT\_ADAFRUIT\_3 \\     
  0x77 & 0x1D & 3 & EVT\_ADAFRUIT\_4 \\     
  0x78 & 0x1E & 0 & EVT\_ADAFRUIT\_5 \\     
  0x79 & 0x1E & 1 & EVT\_ADAFRUIT\_6 \\     
  0x7A & 0x1E & 2 & EVT\_ADAFRUIT\_7 \\     
  0x7B & 0x1E & 3 & EVT\_ADAFRUIT\_8 \\     
  0x7C & 0x1F & 0 & EVT\_ADAFRUIT\_9 \\     
  \hline
\end{tabular}
...
1. If `COMMAND` in byte 0 is non-zero, the specified command is executed and **rest of the action data structure is ignored**.  
...
\begin{tabular}{ | c | l | p{8.2cm} | }
  ...
  \hline  
  0x00 & \footnotesize COMMAND\_NONE                 & No action  \\
  0x01 & \footnotesize COMMAND\_ALL\_OFF             & Shut off all motor channels, light output ports, and stop all audio playback \\
  0x02 & \footnotesize COMMAND\_IR\_LOCKOUT\_ON      & Activate IR receiver lockout, ignores IR receiver packets \\
  0x03 & \footnotesize COMMAND\_IR\_LOCKOUT\_OFF     & Deactivate IR receiver lockout, resumes processing of IR receiver \\
  0x04 & \footnotesize COMMAND\_IR\_LOCKOUT\_TOGGLE  & Toggle the state of the IR lockout mode \\
  0x05 & \footnotesize COMMAND\_ALL\_MOTORS\_OFF     & Turn off all motor channels \\
  0x06 & \footnotesize COMMAND\_ALL\_LIGHTS\_OFF     & Turn off all lighting channels \\
  0x07 & \footnotesize COMMAND\_ALL\_AUDIO\_OFF      & Stop all audio playback \\
  0x08 & \footnotesize COMMAND\_RESTART              & Stop all current actions, and restart with all STARTUP actions \\
  \hline
\end{tabular}
...
\begin{tabular}{ | c | l | p{7.7cm} | }
  ...
  ID & MNEMONIC & Description \\
  \hline  
  0x00 & \footnotesize MOTOR\_ESTOP                  & Motor braked to stop immediately (emergency stop) \\
  0x01 & \footnotesize MOTOR\_STOP                   & Motor commanded to stop using the configured deceleration rate. \\
  0x02 & \footnotesize MOTOR\_INC\_SPEED             & Increase motor speed one step (up to vMax) \\
  0x03 & \footnotesize MOTOR\_DEC\_SPEED             & Decrease motor speed one step (clamped to zero) \\
  0x04 & \footnotesize MOTOR\_INC\_SPEED\_BIDIR      & Increase motor speed one step; passing zero changes direction \\
  0x05 & \footnotesize MOTOR\_DEC\_SPEED\_BIDIR      & Decrease motor speed one step; passing zero changes direction \\
  0x06 & \footnotesize MOTOR\_CHANGE\_DIR            & Change motor direction (motor must be stopped first) \\
  0x07 & \footnotesize MOTOR\_SET\_SPD               & Sets the motor speed to specific value \\
  0x08 & \footnotesize MOTOR\_SET\_SPD\_TIMED        & Sets the motor speed to run for a fixed time \\
  0x09 & \footnotesize MOTOR\_OSCILLATE              & Oscillate motor speed on and off \\
  0x0A & \footnotesize MOTOR\_OSCILLATE\_BIDIR       & Oscillate motor speed forward/reverse \\
  0x0B & \footnotesize MOTOR\_OSCILLATE\_BIDIR\_WAIT & Oscillate motor speed forward/reverse with a wait interval in between \\
  0x0C & \footnotesize MOTOR\_RANDOM                 & Set random motor speed periodically within set speed \\
  0x0D & \footnotesize MOTOR\_RANDOM\_BIDIR          & Set random motor speed and direction periodically within set speed \\
  0x0E & \footnotesize MOTOR\_SOUND\_MODULATED       & Set motor speed within set speed modulated by sound intensity \\
  \hline
\end{tabular}
...
\begin{tabular}{ | c | l | l | l | }
  \hline
  ID & MNEMONIC & \footnotesize MOTOR\_PARAM1 & \footnotesize MOTOR\_PARAM2 \\
  \hline  
  0x00 & \footnotesize MOTOR\_ESTOP                  &                             &  \\
  0x01 & \footnotesize MOTOR\_STOP                   &                             &  \\
  0x02 & \footnotesize MOTOR\_INC\_SPEED             & \footnotesize MOTOR\_STEP   &  \\
  0x03 & \footnotesize MOTOR\_DEC\_SPEED             & \footnotesize MOTOR\_STEP   &  \\
  0x04 & \footnotesize MOTOR\_INC\_SPEED\_BIDIR      & \footnotesize MOTOR\_STEP   &  \\
  0x05 & \footnotesize MOTOR\_DEC\_SPEED\_BIDIR      & \footnotesize MOTOR\_STEP   &  \\
  0x06 & \footnotesize MOTOR\_CHANGE\_DIR            &                             &  \\
  0x07 & \footnotesize MOTOR\_SET\_SPD               & \footnotesize MOTOR\_SPEED  &  \\
  0x08 & \footnotesize MOTOR\_SET\_SPD\_TIMED        & \footnotesize MOTOR\_SPEED  & \footnotesize DURATION \\
  0x09 & \footnotesize MOTOR\_OSCILLATE              & \footnotesize MOTOR\_SPEED  & \footnotesize MOTOR\_PERIOD \\
  0x0A & \footnotesize MOTOR\_OSCILLATE\_BIDIR       & \footnotesize MOTOR\_SPEED  & \footnotesize MOTOR\_PERIOD \\
  0x0B & \footnotesize MOTOR\_OSCILLATE\_BIDIR\_WAIT & \footnotesize MOTOR\_SPEED  & \footnotesize MOTOR\_PERIOD \\
  0x0C & \footnotesize MOTOR\_RANDOM                 & \footnotesize MOTOR\_SPEED  & \footnotesize MOTOR\_PERIOD \\ 
  0x0D & \footnotesize MOTOR\_RANDOM\_BIDIR          & \footnotesize MOTOR\_SPEED  & \footnotesize MOTOR\_PERIOD \\ 
  0x0E & \footnotesize MOTOR\_SOUND\_MODULATED       & \footnotesize MOTOR\_SPEED  &  \\
  \hline
\end{tabular}
...
\begin{tabular}{ | c | l | l | }
  ...
  ID  & MNEMONIC                                     & Description \\
  \hline
  0x01 & \footnotesize LIGHTFX\_ON\_OFF\_TOGGLE      & Toggle light output on/off                 \\
  0x02 & \footnotesize LIGHTFX\_INC\_BRIGHTNESS      & Increase brightness one step               \\
  0x03 & \footnotesize LIGHTFX\_DEC\_BRIGHTNESS      & Decrease brightness one step               \\
  0x04 & \footnotesize LIGHTFX\_SET\_BRIGHTNESS      & Set brightness to specified level          \\
  0x05 & \footnotesize LIGHTFX\_FLASH\_50\_POS       & 50\% duty cycle flasher (pos phase)         \\
  0x06 & \footnotesize LIGHTFX\_FLASH\_50\_NEG       & 50\% duty cycle flasher (neg phase)         \\
  0x07 & \footnotesize LIGHTFX\_STROBE\_POS          & strobe light flasher (pos phase)           \\
  0x08 & \footnotesize LIGHTFX\_STROBE\_NEG          & strobe light flasher (neg phase)           \\
  0x09 & \footnotesize LIGHTFX\_GYRALITE\_POS        & fading MARS/Gyralite flasher (pos phase)   \\
  0x0A & \footnotesize LIGHTFX\_GYRALITE\_NEG        & fading MARS/Gyralite flasher (neg phase)   \\
  0x0B & \footnotesize LIGHTFX\_FLICKER              & random flickering light                    \\
  0x0C & \footnotesize LIGHTFX\_RANDOM\_BLINK        & random blinking light                      \\
  0x0D & \footnotesize LIGHTFX\_PHOTON\_TORPEDO      & photon torpedo effect                      \\
  0x0E & \footnotesize LIGHTFX\_LASER\_PULSE         & shooting laser effect                      \\
  0x0F & \footnotesize LIGHTFX\_SCIFI\_ENGINE\_GLOW  & glowing/pulsating engine glow effect       \\
  0x10 & \footnotesize LIGHTFX\_LIGHTHOUSE           & rotating lighthouse effect                 \\
  0x11 & \footnotesize LIGHTFX\_BROKEN\_LIGHT        & flickering faulty light effect             \\
  0x12 & \footnotesize LIGHTFX\_STATUS\_INDICATOR    & a status indicator of PFX events and status \\
  0x13 & \footnotesize LIGHTFX\_SOUND\_MODULATED     & sound modulated light intensity \\
  0x14 & \footnotesize LIGHTFX\_MOTOR\_MODULATED     & motor speed modulated light intensity \\
  \hline
\end{tabular}
...
\begin{tabular}{ | c | l | c | c | c | }
  \hline
  ID  & MNEMONIC                                    & \footnotesize LIGHT\_PARAM1 & \footnotesize LIGHT\_PARAM2 & \footnotesize LIGHT\_PARAM3  \\
  \hline
  0x01 & \footnotesize LIGHTFX\_ON\_OFF\_TOGGLE     & \footnotesize DIR\_OPTION   & \footnotesize  FADE\_TIME   & \footnotesize FLICKER\_ON \\
  0x02 & \footnotesize LIGHTFX\_INC\_BRIGHTNESS     & \footnotesize               & \footnotesize               &     \\
  0x03 & \footnotesize LIGHTFX\_DEC\_BRIGHTNESS     & \footnotesize               & \footnotesize               &     \\
  0x04 & \footnotesize LIGHTFX\_SET\_BRIGHTNESS     & \footnotesize BRIGHTNESS    & \footnotesize               &     \\
  0x05 & \footnotesize LIGHTFX\_FLASH\_50\_POS      & \footnotesize PERIOD        & \footnotesize FADE\_FACTOR  &      \\
  0x06 & \footnotesize LIGHTFX\_FLASH\_50\_NEG      & \footnotesize PERIOD        & \footnotesize FADE\_FACTOR  &      \\
  0x07 & \footnotesize LIGHTFX\_STROBE\_POS         & \footnotesize PERIOD        & \footnotesize DUTY\_CYCLE   & \footnotesize BURST\_COUNT \\
  0x08 & \footnotesize LIGHTFX\_STROBE\_NEG         & \footnotesize PERIOD        & \footnotesize DUTY\_CYCLE   & \footnotesize BURST\_COUNT \\
  0x09 & \footnotesize LIGHTFX\_GYRALITE\_POS       & \footnotesize PERIOD        & \footnotesize FADE\_FACTOR  &     \\
  0x0A & \footnotesize LIGHTFX\_GYRALITE\_NEG       & \footnotesize PERIOD        & \footnotesize FADE\_FACTOR  &     \\
  0x0B & \footnotesize LIGHTFX\_FLICKER             & \footnotesize PERIOD2       & \footnotesize FADE\_FACTOR  &     \\
  0x0C & \footnotesize LIGHTFX\_RANDOM\_BLINK       & \footnotesize PERIOD2       & \footnotesize FADE\_FACTOR  &     \\
  0x0D & \footnotesize LIGHTFX\_PHOTON\_TORPEDO     & \footnotesize PERIOD2       & \footnotesize               &     \\
  0x0E & \footnotesize LIGHTFX\_LASER\_PULSE        & \footnotesize PERIOD2       & \footnotesize               &     \\
  0x0F & \footnotesize LIGHTFX\_SCIFI\_ENGINE\_GLOW & \footnotesize PERIOD        & \footnotesize FADE\_FACTOR  &     \\
  0x10 & \footnotesize LIGHTFX\_LIGHTHOUSE          & \footnotesize PERIOD        & \footnotesize               &     \\
  0x11 & \footnotesize LIGHTFX\_BROKEN\_LIGHT       & \footnotesize FAULT\_RATE   & \footnotesize FADE\_TIME    & \footnotesize FAULT\_INTENSITY \\
  0x12 & \footnotesize LIGHTFX\_STATUS\_INDICATOR   & \footnotesize SOURCE1       & \footnotesize SOURCE2       & \footnotesize INVERT \\
  0x13 & \footnotesize LIGHTFX\_SOUND\_MODULATED    & \footnotesize FADE\_TIME    &                             & \footnotesize INVERT \\
  0x14 & \footnotesize LIGHTFX\_MOTOR\_MODULATED    & \footnotesize FADE\_TIME    & \footnotesize SOURCE2       & \footnotesize INVERT \\
  \hline
\end{tabular}
\bigskip 
\pagebreak
...
\begin{tabular}{ | c | l | c | c | c | }
  ...
  ID  & MNEMONIC                                    & \footnotesize LIGHT\_PARAM1 & \footnotesize LIGHT\_PARAM2 & \footnotesize LIGHT\_PARAM3  \\
  \hline
  0x01 & \footnotesize LIGHTFX\_ON\_OFF\_TOGGLE     &  0x00 : None     &  0x00 : No Fade & 0x00 : No flicker \\
  0x02 & \footnotesize LIGHTFX\_INC\_BRIGHTNESS     &                  &               &     \\
  0x03 & \footnotesize LIGHTFX\_DEC\_BRIGHTNESS     &                  &               &     \\
  0x04 & \footnotesize LIGHTFX\_SET\_BRIGHTNESS     &  0x7F            &               &     \\
  0x05 & \footnotesize LIGHTFX\_FLASH\_50\_POS      &  0x04 : 1 sec.   & 0x03 : 10\%   &      \\
  0x06 & \footnotesize LIGHTFX\_FLASH\_50\_NEG      &  0x04 : 1 sec.   & 0x03 : 10\%   &      \\
  0x07 & \footnotesize LIGHTFX\_STROBE\_POS         &  0x04 : 1 sec.   & 0x04 : 15\%   & 0x01 : 2 pulses \\
  0x08 & \footnotesize LIGHTFX\_STROBE\_NEG         &  0x04 : 1 sec.   & 0x04 : 15\%   & 0x01 : 2 pulses \\
  0x09 & \footnotesize LIGHTFX\_GYRALITE\_POS       &  0x04 : 1 sec.   & 0x09 : 50\%   &     \\
  0x0A & \footnotesize LIGHTFX\_GYRALITE\_NEG       &  0x04 : 1 sec.   & 0x09 : 50\%   &     \\
  0x0B & \footnotesize LIGHTFX\_FLICKER             &  0x01 : 0.1 sec. & 0x06 : 25\%   &     \\
  0x0C & \footnotesize LIGHTFX\_RANDOM\_BLINK       &  0x02 : 0.2 sec. & 0x03 : 10\%   &     \\
  0x0D & \footnotesize LIGHTFX\_PHOTON\_TORPEDO     &  0x0A : 1 sec.   &               &     \\
  0x0E & \footnotesize LIGHTFX\_LASER\_PULSE        &  0x01 : 0.1 sec. &               &     \\
  0x0F & \footnotesize LIGHTFX\_SCIFI\_ENGINE\_GLOW &  0x08 : 2 sec.   & 0x09 : 50\%   &     \\
  0x10 & \footnotesize LIGHTFX\_LIGHTHOUSE          &  0x0A : 3 sec.   &               &     \\
  0x11 & \footnotesize LIGHTFX\_BROKEN\_LIGHT       &  0x02 : Often    & 0x00 : None   & 0x02 : Severe \\
  0x12 & \footnotesize LIGHTFX\_STATUS\_INDICATOR   &  0x01            & 0x00          & 0x00 \\
  0x13 & \footnotesize LIGHTFX\_SOUND\_MODULATED    &  0x03 : 10\%     &               &   \\
  0x14 & \footnotesize LIGHTFX\_MOTOR\_MODULATED    &  0x03 : 10\%     & 0x00 : None   & 0x00 : not inverted \\
  \hline
\end{tabular}
\medskip
...
\begin{tabular}{ | c | l | l | }
  ...
  ID & MNEMONIC & Description \\
  \hline
  0x01 & \footnotesize COMBOFX\_LINEAR\_SWEEP     &  Linear sweep of sequential lights                    \\
  0x02 & \footnotesize COMBOFX\_BARGRAPH\_SWEEP   &  Linear bargraph sweep                                \\
  0x03 & \footnotesize COMBOFX\_KNIGHT\_RIDER     &  Knight rider back-forth scanner                      \\
  0x04 & \footnotesize COMBOFX\_EMCY\_TWINSONIC   &  Emergency vehicle with twinsonic lightbars           \\
  0x05 & \footnotesize COMBOFX\_EMCY\_WHELEN      &  Emergency vehicle with Whelen lightbars              \\
  0x06 & \footnotesize COMBOFX\_TIMES\_SQUARE     &  Constantly changing patterns of sweeping lights      \\
  0x07 & \footnotesize COMBOFX\_NOISE             &  Random patterns                                      \\
  0x08 & \footnotesize COMBOFX\_TWINKLING\_STARS  &  Simulated twinkling star field effect                \\
  0x09 & \footnotesize COMBOFX\_TRAFFIC\_LIGHTS   &  Traffic light sequence including pedestrian crossing \\
  0x0A & \footnotesize COMBOFX\_SOUND\_BAR        &  A bargraph modulated by sound playback               \\
  0x0B & \footnotesize COMBOFX\_ALTERNATE\_FLASH  &  A pair of lights which flash in opposite phases      \\
  0x0C & \footnotesize COMBOFX\_LAVA\_LAMP        &  A soft fluid modulated light effect                  \\
  0x0D & \footnotesize COMBOFX\_LASER\_CANNON     &  A one-shot sweeping light effect                     \\
  \hline
\end{tabular}
...
\begin{tabular}{| c | c | c | c | c | c | c |}
  \hline
  \multicolumn{7}{|c|}{Light Output} \\
  \hline
  1 & 2 & 3 & 4 & 5 & 6 & 7 \\
  \hline
  \multicolumn{4}{|c|}{Light bar} & \multicolumn{3}{c|}{Auxilary Flashers} \\
  \hline
  \multicolumn{2}{|c|}{Left} & \multicolumn{2}{|c|}{Right} & \multicolumn{2}{|c|}{1x flash} & 2x flash \\ \cline{1-6}
...
\begin{tabular}{ | c | l | c | c | c | }
  ...
  ID   & MNEMONIC                                 & \footnotesize LIGHT\_PARAM1 & \footnotesize LIGHT\_PARAM2 & \footnotesize LIGHT\_PARAM3 \\
  \hline
  0x01 & \footnotesize COMBOFX\_LINEAR\_SWEEP     & \footnotesize PERIOD        & \footnotesize FADE\_FACTOR  &  \footnotesize SIZE         \\ \cline{3-3}
       &                                          & \footnotesize LIGHT\_PARAM4 & & \\ \cline{3-3}
       &                                          & \footnotesize SWEEP\_STYLE & & \\
  0x02 & \footnotesize COMBOFX\_BARGRAPH\_SWEEP   & \footnotesize PERIOD        & \footnotesize FADE\_FACTOR  &  \footnotesize SIZE         \\ \cline{3-3}
       &                                          & \footnotesize LIGHT\_PARAM4 & & \\ \cline{3-3}
       &                                          & \footnotesize SWEEP\_STYLE & & \\
  0x03 & \footnotesize COMBOFX\_KNIGHT\_RIDER     & \footnotesize PERIOD        & \footnotesize FADE\_FACTOR  &  \footnotesize SIZE         \\
  0x04 & \footnotesize COMBOFX\_EMCY\_TWINSONIC   & \footnotesize TWIN\_STYLE   &  \footnotesize SEQ          & \footnotesize FLASH\_RATE \\
  0x05 & \footnotesize COMBOFX\_EMCY\_WHELEN      & \footnotesize WHELEN\_STYLE &  \footnotesize SEQ          & \footnotesize FLASH\_RATE \\
  0x06 & \footnotesize COMBOFX\_TIMES\_SQUARE     & \footnotesize PERIOD2       &  \footnotesize FADE\_FACTOR &   \\
  0x07 & \footnotesize COMBOFX\_NOISE             & \footnotesize PERIOD2       &  \footnotesize FADE\_FACTOR &   \\
  0x08 & \footnotesize COMBOFX\_TWINKLING\_STARS  & \footnotesize PERIOD        &  \footnotesize FADE\_FACTOR &   \\
  0x09 & \footnotesize COMBOFX\_TRAFFIC\_LIGHTS   & \footnotesize TRAFFIC\_STYLE & \footnotesize FADE\_FACTOR & \footnotesize SEQ\_TIME \\
  0x0A & \footnotesize COMBOFX\_SOUND\_BAR        & \footnotesize BAR\_STYLE    & \footnotesize FADE\_FACTOR  &  \footnotesize SIZE         \\
  0x0B & \footnotesize COMBOFX\_ALTERNATE\_FLASH  & \footnotesize PERIOD        & \footnotesize FADE\_FACTOR  & \footnotesize DUTY\_CYCLE  \\ \cline{3-3}
       &                                          & \footnotesize LIGHT\_PARAM4 & & \\ \cline{3-3}
       &                                          & \footnotesize OUT\_MASK & & \\
  0x0C & \footnotesize COMBOFX\_LAVA\_LAMP        & \footnotesize PERIOD        & \footnotesize SIZE &         \\
  0x0D & \footnotesize COMBOFX\_LASER\_CANON      & \footnotesize FLASH\_RATE    & \footnotesize FADE\_FACTOR & \footnotesize SIZE \\ \cline{3-3}
       &                                          & \footnotesize LIGHT\_PARAM4 & & \\ \cline{3-3}
       &                                          & \footnotesize SWEEP\_STYLE & & \\
  \hline
\end{tabular}
...
\begin{tabular}{ | c | l | c | c | c | }
  ...
  ID   & MNEMONIC                                 & \footnotesize LIGHT\_PARAM1 & \footnotesize LIGHT\_PARAM2 & \footnotesize LIGHT\_PARAM3 \\
  \hline
  0x01 & \footnotesize COMBOFX\_LINEAR\_SWEEP     & 0x02 : 0.5 sec.    & 0x06 : 25\%  &  0x00 : 8 lights         \\ \cline{3-3}
       &                                          & \footnotesize LIGHT\_PARAM4 & & \\ \cline{3-3}
       &                                          & 0x01 : R to L & & \\
  0x02 & \footnotesize COMBOFX\_BARGRAPH\_SWEEP   &  0x04 : 1.0 sec.   & 0x03 : 10\%  & 0x00 : 8 lights         \\ \cline{3-3}
       &                                          & \footnotesize LIGHT\_PARAM4 & & \\ \cline{3-3}
       &                                          & 0x01 : R to L & & \\
  0x03 & \footnotesize COMBOFX\_KNIGHT\_RIDER     & 0x06 : 1.5 sec. & 0x06 : 25\%  &  0x00 : 8 lights  \\
  0x04 & \footnotesize COMBOFX\_EMCY\_TWINSONIC   & 0x02 : Aero   & 0x01 : L/R & 0x02 : Fast \\
  0x05 & \footnotesize COMBOFX\_EMCY\_WHELEN      & 0x0A : Random &  0x02 : In/Out  & 0x02 : Fast \\
  0x06 & \footnotesize COMBOFX\_TIMES\_SQUARE     & 0x01 : 0.1 sec.  & 0x0A : 75\% &   \\
  0x07 & \footnotesize COMBOFX\_NOISE             & 0x01 : 0.1 sec.  & 0x09 : 50\% &   \\
  0x08 & \footnotesize COMBOFX\_TWINKLING\_STARS  & 0x08 : 2 sec. & 0x0F : 400\% &   \\
  0x09 & \footnotesize COMBOFX\_TRAFFIC\_LIGHTS   & 0x04 : Std w/Xing & 0x06 : 25\% & 0x01 : Med \\
  0x0A & \footnotesize COMBOFX\_SOUND\_BAR        & 0x00 : L to R  & 0x06 : 25\%  &  0x00 : 8 lights         \\
  0x0B & \footnotesize COMBOFX\_ALTERNATE\_FLASH  & 0x04 : 1 sec.   & 0x09 : 50\%  & 0x06 : 25\%  \\ \cline{3-3}
       &                                          & \footnotesize LIGHT\_PARAM4 & & \\ \cline{3-3}
       &                                          & 0x0F & & \\
  0x0C & \footnotesize COMBOFX\_LAVA\_LAMP        & 0x04 : 1 sec.  & 0x00 : 8 lights &         \\
  0x0D & \footnotesize COMBOFX\_LASER\_CANON      & 0x03 : Very Fast  & 0x06 : 25\% & 0x04 : 4 lights \\ \cline{3-3}
       &                                          & \footnotesize LIGHT\_PARAM4 & & \\ \cline{3-3}
       &                                          & 0x01 : R to L & & \\
  \hline
\end{tabular}
...
\begin{tabular}{ | c | l | }
  ...
  0x08 & European 2 (Austrian style with flashing green cycle) \\
  0x09 & European 2 with pedestrian crossing \\
  \hline
\end{tabular}
\normalsize
...
\begin{tabular}{ | c | l | p{7cm} | }
  ...
  ID   & MNEMONIC                                         & Description \\
  \hline                          
  0x00 & \footnotesize SOUNDFX\_NONE                      & No audio effect                                             \\
  0x01 & \footnotesize SOUNDFX\_INC\_VOLUME               & Increase master volume one step                        \\
  0x02 & \footnotesize SOUNDFX\_DEC\_VOLUME               & Decrease master volume one step                        \\
  0x03 & \footnotesize SOUNDFX\_SET\_VOLUME               & Set volume to a specific step                          \\
  0x04 & \footnotesize SOUNDFX\_PLAY\_ONCE                & Play sound file one time                               \\
  0x05 & \footnotesize SOUNDFX\_PLAY\_CONTINUOUS          & Play sound file continuously (effect can be toggled)   \\
  0x06 & \footnotesize SOUNDFX\_PLAY\_NTIMES              & Play sound file a specified number of times            \\
  0x07 & \footnotesize SOUNDFX\_PLAY\_DURATION            & Loop sound file playback for a specified duration      \\
  0x08 & \footnotesize SOUNDFX\_PLAY\_PITCHBEND\_MOTOR    & Play sound file continuous; modulate pitch as a function of motor speed       \\
  0x09 & \footnotesize SOUNDFX\_PLAY\_GATED\_MOTOR        & Play sound file; then silence at a rate proportional to motor speed (e.g. for "chuffing" sound)  \\
  0x0A & \footnotesize SOUNDFX\_PLAY\_AM\_MOTOR           & Play sound file continuous; modulate volume as a function of motor speed      \\
  0x0B & \footnotesize SOUNDFX\_STOP                      & Stop playback of specified sound file  \\
  0x0C & \footnotesize SOUNDFX\_PLAY\_IDX\_MOTOR          & Play sound files automatically indexed by motor speed. Allows for realistic simulation of engine sounds stored in audio files. \\
  0x0D & \footnotesize SOUNDFX\_PLAY\_RAND                & Play sound file at randomly defined time intervals \\
  \hline
\end{tabular}
...
\begin{tabular}{ | c | l | c | c | }
  \hline
  ID   & MNEMONIC                                         & \footnotesize SOUND\_PARAM1 & \footnotesize SOUND\_PARAM2 \\
  \hline                          
  0x00 & \footnotesize SOUNDFX\_NONE                      &                             &                             \\
  0x01 & \footnotesize SOUNDFX\_INC\_VOLUME               &                             &                             \\
  0x02 & \footnotesize SOUNDFX\_DEC\_VOLUME               &                             &                             \\
  0x03 & \footnotesize SOUNDFX\_SET\_VOLUME               &                             & \footnotesize VOLUME        \\
  0x04 & \footnotesize SOUNDFX\_PLAY\_ONCE                & \footnotesize RETRIGGER     & \footnotesize RELVOLUME     \\
  0x05 & \footnotesize SOUNDFX\_PLAY\_CONTINUOUS          &                             & \footnotesize RELVOLUME     \\
  0x06 & \footnotesize SOUNDFX\_PLAY\_NTIMES              & \footnotesize REPEAT\_COUNT & \footnotesize RELVOLUME     \\
  0x07 & \footnotesize SOUNDFX\_PLAY\_DURATION            & \footnotesize DURATION      & \footnotesize RELVOLUME     \\
  0x08 & \footnotesize SOUNDFX\_PLAY\_PITCHBEND\_MOTOR    & \footnotesize MOTOR\_OUTPUT & \footnotesize GAIN          \\
  0x09 & \footnotesize SOUNDFX\_PLAY\_GATED\_MOTOR        & \footnotesize MOTOR\_OUTPUT & \footnotesize GAIN          \\
  0x0A & \footnotesize SOUNDFX\_PLAY\_AM\_MOTOR           & \footnotesize MOTOR\_OUTPUT & \footnotesize GAIN          \\
  0x0B & \footnotesize SOUNDFX\_STOP                      &                             &                             \\
  0x0C & \footnotesize SOUNDFX\_PLAY\_IDX\_MOTOR          & \footnotesize MOTOR\_OUTPUT & \footnotesize IDX\_OPTIONS \\
  0x0D & \footnotesize SOUNDFX\_PLAY\_RAND                & \footnotesize PROBABILITY   &  \\
  \hline
\end{tabular}
...
\medskip
\begin{bytefield}[bitwidth=\widthof{MODULATION~},endianness=big]{4}
  \bitheader{0-3} \\
...
\begin{tabular}{ | c | p{7.7cm} | c | c | c | }
  ...
  \hline
  0x08 & PFX\_CMD\_GET\_ICD\_REV          & y        & y          & y \\  
  0x01 & PFX\_CMD\_GET\_STATUS            & y        & y          & y \\  
  0x02 & PFX\_CMD\_SET\_FACTORY\_DEFAULTS & y        &            & y \\  
  0x03 & PFX\_CMD\_GET\_CONFIG            & y        &            & y \\  
  0x04 & PFX\_CMD\_SET\_CONFIG            & y        &            & y \\  
  0x06 & PFX\_CMD\_GET\_CURRENT\_STATE    & y        &            & y \\  
  0x07 & PFX\_CMD\_GET\_NAME              & y        &            & y \\
  0x09 & PFX\_CMD\_SET\_NAME              & y        &            & y \\
  \hline
\end{tabular}
\normalsize
\medskip
...
\begin{tabular}{ | c | p{7.7cm} | c | c | c | }
  ...
  CMD & Nmemonic                          & Firmware & Bootloader & Host App  \\
  \hline
  0x11 & PFX\_CMD\_GET\_EVENT\_ACTION          & y        &            & y \\  
  0x12 & PFX\_CMD\_SET\_EVENT\_ACTION          & y        &            & y \\  
  0x13 & PFX\_CMD\_TEST\_ACTION                & y        &            & y \\  
  0x15 & PFX\_CMD\_SEND\_EVENT                 & y        &            & y \\
  \hline
\end{tabular}
\normalsize
\medskip
...
\begin{tabular}{ | c | p{7.7cm} | c | c | c | }
  ...
  CMD & Nmemonic                          & Firmware & Bootloader & Host App  \\
  \hline
  0x20 & PFX\_CMD\_INC\_VOLUME            & y        &            & y \\  
  0x21 & PFX\_CMD\_DEC\_VOLUME            & y        &            & y \\  
  0x2A & PFX\_CMD\_SET\_AUDIO\_EQ         & y        &            & y \\  
  \hline
\end{tabular}
\normalsize
\medskip
...
\begin{tabular}{ | c | p{7.7cm} | c | c | c | }
  ...
  CMD & Nmemonic                          & Firmware & Bootloader & Host App  \\
  \hline
  0x30 & PFX\_CMD\_LOAD\_FIRMWARE\_FILE  & y        & y          & y \\  
  0x31 & PFX\_CMD\_LOAD\_FIRMWARE\_DATA  & y        & y          & y \\  
  0x32 & PFX\_CMD\_LOAD\_FIRMWARE\_DONE  & y        & y          & y \\  
  0x34 & PFX\_CMD\_READ\_BOOTCONFIG      &          & y          &  \\  
  0x37 & PFX\_CMD\_REBOOT                & y        & y          & y \\  
  \hline
\end{tabular}
\normalsize
...
\begin{tabular}{ | c | p{7.7cm} | c | c | c | }
  ...
  CMD & Nmemonic                                & Firmware & Bootloader & Host App  \\
  \hline
  0x40 & PFX\_CMD\_FILE\_OPEN              & y        &            &  y \\  
  0x41 & PFX\_CMD\_FILE\_CLOSE             & y        &            &  y \\  
  0x42 & PFX\_CMD\_FILE\_READ              & y        &            &  y \\  
  0x43 & PFX\_CMD\_FILE\_WRITE             & y        &            &  y \\  
  0x44 & PFX\_CMD\_FILE\_SEEK              & y        &            &  y \\  
  0x45 & PFX\_CMD\_FILE\_DIR               & y        &            &  y \\
  0x46 & PFX\_CMD\_FILE\_REMOVE            & y        &            &  y \\
  0x47 & PFX\_CMD\_FILE\_FORMAT\_FS        & y        &            &  y \\
  0x48 & PFX\_CMD\_FILE\_GET\_FS\_STATE    & y        &            &  y \\
  \hline
\end{tabular}
\normalsize
\medskip
...
\begin{tabular}{ | c | p{7.7cm} | c | c | c | }
  ...
  CMD & Nmemonic                                & Firmware & Bootloader & Host App  \\
  \hline
  0x50 & PFX\_CMD\_GET\_BT\_STATUS            & y        &            &   \\  
  0x51 & PFX\_CMD\_SET\_BT\_POWER             & y        &            &   \\  
  0x52 & PFX\_CMD\_SEND\_BT\_UART             & y        &            &   \\  
  0x53 & PFX\_CMD\_RECEIVE\_BT\_UART          & y        &            &   \\  
  \hline
\end{tabular}
\normalsize
\medskip
...
\begin{tabular}{ | c | p{7.7cm} | c | c | c | }
  ...
  CMD & Nmemonic                                & Firmware & Bootloader & Host App  \\
  \hline
  0x60 & PFX\_CMD\_SET\_NOTIFICATIONS           & y        &            & y  \\  
  0x61 & PFX\_MSG\_NOTIFICATION                 & y        &            & y  \\  
  \hline
\end{tabular}
\normalsize
\medskip
...
\begin{tabular}{ | c | p{7.7cm} | c | c | c | }
  ...
  CMD & Nmemonic                          & Firmware & Bootloader & Host App  \\
  \hline
  0x70 & PFX\_CMD\_STATUS\_LED           & y        &            &  \\  
  0x72 & PFX\_CMD\_WRITE\_SPI            & y        &            &  \\  
  0x73 & PFX\_CMD\_READ\_SPI             & y        &            &  \\  
  0x74 & PFX\_CMD\_WRITE\_I2C            & y        &            &  \\  
  0x75 & PFX\_CMD\_READ\_I2C             & y        &            &  \\  
  0x76 & PFX\_CMD\_READ\_FLASH           & y        &            &  \\
  0x77 & PFX\_CMD\_GET\_IRRX\_STATUS     & y        &            &  \\
  \hline
\end{tabular}
\normalsize
...
\begin{bytefield}[bitwidth=\widthof{0xAA~},endianness=little]{5}
  \bitheader{0-4} \\
...
\begin{tabular}{ | c | l | p{7.5cm} | }
  ...
  \hline
  0x00 & \footnotesize PFX\_STATUS\_NORMAL           & if the PFx Brick is running its main application firmware, i.e. normal operation \\
  0x33 & \footnotesize PFX\_STATUS\_NORMAL\_PENDING & PFx Brick is running in normal mode with a new application firmware image loaded into staging and pending upgrade \\
  0x55 & \footnotesize PFX\_STATUS\_SERVICE          & PFx Brick is running in Service mode with no errors, i.e. a typical state for a new uninitialized PFx Brick \\
  0x53 & \footnotesize PFX\_STATUS\_SERVICE\_PENDING & PFx Brick is running in Service mode with a new application firmware image loaded into staging and pending upgrade \\
  0x5B & \footnotesize PFX\_STATUS\_SERVICE\_BUSY    & Running in Service mode, busy performing firmware upgrade \\
  \hline
\end{tabular}
\medskip
...
\begin{tabular}{ | c | l | p{7.0cm} | }
  ...
  \hline
  0x00 & \footnotesize PFX\_ERR\_NONE                    & no errors  \\
  0x06 & \footnotesize PFX\_ERR\_TRANSFER\_CRC\_MISMATCH & Error loading firmware from host into staging memory space \\
  0x80 & \footnotesize PFX\_ERR\_UPGRADE\_FAIL           & Error copying staged firmware into active operational flash program memory space \\
  0x0A & \footnotesize PFX\_ERR\_TRAP\_BROWNOUT\_RST     & Reset error due to brownout power condition  \\
  0x10 & \footnotesize PFX\_ERR\_TRAP\_CONFLICT          & Reset error due a trap conflict  \\
  0x20 & \footnotesize PFX\_ERR\_TRAP\_ILLEGAL\_OPCODE   & Reset error due to illegal OP code execution \\
  0x40 & \footnotesize PFX\_ERR\_TRAP\_CONFIG\_MISMATCH  & Reset error due configuration mismatch \\
  \hline
\end{tabular}
\medskip
...
\begin{tabular}{ | c | l | }
  ...
  Event ID & MNEMONIC \\
  \hline
  0x00 & EVT\_8879\_TWO\_BUTTONS  \\
  0x01 & EVT\_8879\_LEFT\_BUTTON  \\
  0x02 & EVT\_8879\_RIGHT\_BUTTON \\
  0x03 & EVT\_8879\_LEFT\_INC     \\
  0x04 & EVT\_8879\_LEFT\_DEC     \\
  0x05 & EVT\_8879\_RIGHT\_INC    \\
  0x06 & EVT\_8879\_RIGHT\_DEC    \\
  0x07 & EVT\_8885\_LEFT\_FWD     \\
  0x08 & EVT\_8885\_LEFT\_REV     \\
  0x09 & EVT\_8885\_RIGHT\_FWD    \\
  0x0A & EVT\_8885\_RIGHT\_REV    \\
  0x0B & EVT\_8885\_LEFT\_CTROFF  \\
  0x0C & EVT\_8885\_RIGHT\_CTROFF  \\
  0x0D & EVT\_EV3\_BEACON \\
  0x0E & EVT\_TEST\_EVENT     \\
  0x0F & EVT\_STARTUP\_EVENT  \\
  0x10 & EVT\_STARTUP\_EVENT2  \\
  \hline
\end{tabular}  
...
\begin{tabular}{ | c | l | p{7.5cm} | }
  ...
  Status & Code & Description \\
  \hline
  0x00 & \footnotesize PFX\_ERR\_TRANSFER\_REQUEST\_OK  & load firmware file request is ok  \\
  0x03 & \footnotesize PFX\_ERR\_TRANSFER\_TOO\_BIG     & file size exceeds free capacity of the firmware staging area \\
  \hline
\end{tabular}
...
\begin{tabular}{ | c | l | p{8.0cm} | }
  ...
  Status & Code & Description \\
  \hline
  0x00 & \footnotesize PFX\_ERR\_NONE              & transfer of firmware payload data ok \\
  0x04 & \footnotesize PFX\_ERR\_TRANSFER\_INVALID & data transfer session is invalid (usually due to a missing \footnotesize PFX\_CMD\_LOAD\_FIRMWARE\_FILE \normalsize packet)  \\
  0x07 & \footnotesize PFX\_ERR\_TRANSFER\_BUSY\_WAIT & data transfer of this packet should wait and try again due to an active time-sensitive write or erase operation. The host should reattempt to send the same data packet and check the Status byte. \\
  \hline
\end{tabular}
...
\begin{tabular}{ | c | l | p{8.0cm} | }
  ...
  Status & Code & Description \\
  \hline
  0x00 & \footnotesize PFX\_ERR\_NONE              & firmware file transfer completed with no errors \\
  0x04 & \footnotesize PFX\_ERR\_TRANSFER\_INVALID       & data transfer session is invalid (usually due to a missing \footnotesize PFX\_CMD\_LOAD\_FIRMWARE\_FILE \normalsize packet)  \\
  0x06 & \footnotesize PFX\_ERR\_TRANSFER\_CRC\_MISMATCH & computed CRC32 of received firmware image does not match provided CRC32 code \\
  \hline
\end{tabular}
...
\begin{tabular}{ | c | l | p{7.5cm} | }
  ...
  \hline
  0x01 & \footnotesize PFX\_FILE\_READ      & open file with read access  \\
  0x02 & \footnotesize PFX\_FILE\_WRITE     & open file with write access \\
  0x04 & \footnotesize PFX\_FILE\_CREATE    & create a new file with ID and size  \\
  \hline
\end{tabular}
...
\begin{tabular}{ | c | l | p{7.5cm} | }
  ...
  Status & Code & Description \\
  \hline
  0x00 & \footnotesize PFX\_ERR\_NONE                   & file system operation ok \\
  0xF0 & \footnotesize PFX\_ERR\_FILE\_SYSTEM\_ERR      & overall file system error \\
  0xF1 & \footnotesize PFX\_ERR\_FILE\_INVALID          & file request was invalid or file is invalid  \\
  0xF2 & \footnotesize PFX\_ERR\_FILE\_OUT\_OF\_RANGE   & file access request is outside of file size  \\
  0xF3 & \footnotesize PFX\_ERR\_FILE\_READ\_ONLY       & file creation or write access denied \\
  0xF4 & \footnotesize PFX\_ERR\_FILE\_TOO\_BIG         & requested file creation is too big  \\
  0xF5 & \footnotesize PFX\_ERR\_FILE\_NOT\_FOUND       & requested file ID is not found \\
  0xF6 & \footnotesize PFX\_ERR\_FILE\_NOT\_UNIQUE      & requested file creation ID is already used  \\
  0xF7 & \footnotesize PFX\_ERR\_FILE\_LOCKED\_BUSY     & file system is locked or busy  \\
  0xF8 & \footnotesize PFX\_ERR\_FILE\_SYSTEM\_FULL     & file system full \\
  0xF9 & \footnotesize PFX\_ERR\_FILE\_SYSTEM\_TIMEOUT  & file access operation time out \\
  0xFA & \footnotesize PFX\_ERR\_FILE\_INVALID\_ADDRESS & file system request resulted in an invalid memory address \\
  0xFB & \footnotesize PFX\_ERR\_FILE\_NEXT\_SECTOR     & file system FAT points to an invalid sector \\
  0xFC & \footnotesize PFX\_ERR\_FILE\_ACCESS\_DENIED   & file system operation denied or prohibited \\
  0xFF & \footnotesize PFX\_ERR\_FILE\_EOF              & file access has reached the end of the file \\
  \hline
\end{tabular}
...
\begin{bytefield}[bitwidth=\widthof{0xFF~},endianness=little]{4}
  \bitheader{0-3} \\
  \bitbox{1}{0x74} & \bitbox{1}{\tiny Dev Address} & \bitbox{1}{\tiny Reg Address} & \bitbox{1}{\tiny Data}\\
\end{bytefield}
...
\begin{bytefield}[bitwidth=\widthof{0xFF~},endianness=little]{3}
  \bitheader{0-2} \\
  \bitbox{1}{0x75} & \bitbox{1}{\tiny Dev Address} & \bitbox{1}{\tiny Reg Address} \\
\end{bytefield}
...
\begin{bytefield}[bitwidth=\widthof{0xFF~},endianness=little]{16}
  \bitheader{0-15} \\
  \bitbox{1}{0xF5} & \bitbox{1}{\tiny num Bytes (m)} & \bitbox{14}{Received I2C data bytes}\\
  \bitbox[]{16}{$\vdots$ \\[1ex]} \\
  \bitheader[lsb=48]{48-63} \\
...
\begin{bytefield}[bitwidth=\widthof{0xFF~},endianness=little]{6}
  \bitheader{0-5} \\
  \bitbox{1}{0x76} & \bitbox{4}{Address[31:0]} & \bitbox{1}{\tiny num Bytes n} \\
\end{bytefield}
...
\begin{bytefield}[bitwidth=\widthof{Sleep~},endianness=little]{2}
  \bitheader{0-1} \\
...
\begin{bytefield}[bitwidth=\widthof{Sleep~},endianness=little]{1}
  \bitheader[lsb=0]{0}  \\
  \bitbox{1}{0xD1} \\
\end{bytefield}
...
\begin{bytefield}[bitwidth=\widthof{0x72~},endianness=little]{16}
  \bitheader{0-15} \\
  \bitbox{1}{0x52} & \bitbox{1}{\tiny num Bytes} & \bitbox{14}{UART data bytes}\\
  \bitbox[]{16}{$\vdots$ \\[1ex]} \\
  \bitheader[lsb=48]{48-63} \\
  \wordbox{1}{UART data bytes (up to 62)} \\
\end{bytefield}

`numBytes(n)` specifies how many payload bytes are contained in this packet (<=62)
...
\begin{bytefield}[bitwidth=\widthof{0xD3~},endianness=little]{16}
  \bitheader{0-15} \\
  \bitbox{1}{0xD3} & \bitbox{1}{\tiny num Bytes (m)} & \bitbox{14}{Received data bytes}\\
  \bitbox[]{16}{$\vdots$ \\[1ex]} \\
  \bitheader[lsb=48]{48-63} \\
  \wordbox{1}{Received data bytes (up to 62)} \\
\end{bytefield}

`numBytes(m)` specifies how many bytes are contained in this packet (<=62)  
...
\begin{tabular}{ | l | l | p{5cm} | }
  ...
  \hline
  0x01 & \footnotesize PFX\_NOTIFICATION\_AUDIO\_PLAY\_DONE \normalsize & File ID of audio file \\
  0x02 & \footnotesize PFX\_NOTIFICATION\_AUDIO\_PLAY       \normalsize & File ID of audio file \\
  0x04 & \footnotesize PFX\_NOTIFICATION\_MOTORA\_CURR\_SPD \normalsize & Current motor speed \\
  0x08 & \footnotesize PFX\_NOTIFICATION\_MOTORA\_STOP      \normalsize & n/a \\
  0x10 & \footnotesize PFX\_NOTIFICATION\_MOTORB\_CURR\_SPD \normalsize & Current motor speed \\
  0x20 & \footnotesize PFX\_NOTIFICATION\_MOTORB\_STOP      \normalsize & n/a \\
  \hline
\end{tabular}
...
\begin{tabular}{ | c | l | }
  ...
  Code & MNEMONIC  \\
  \hline
  0x00 & PFX\_STATUS\_NORMAL           \\
  0x33 & PFX\_STATUS\_NORMAL\_PENDING  \\
  0x55 & PFX\_STATUS\_SERVICE          \\
  0x53 & PFX\_STATUS\_SERVICE\_PENDING \\
  0x5B & PFX\_STATUS\_SERVICE\_BUSY    \\
  \hline
\end{tabular}
...
Several USB command messages include status feedback bytes which may report error or status conditions.  These are summarized as follows:
...
\begin{tabular}{ | c | l | }
  ...
  \hline
  0x00 & PFX\_ERR\_NONE                       \\
  0x00 & PFX\_ERR\_VERIFY\_PASS               \\
  0x01 & PFX\_ERR\_VERIFY\_FAIL               \\
  0x00 & PFX\_ERR\_TRANSFER\_REQUEST\_OK      \\
  0x02 & PFX\_ERR\_TRANSFER\_FILE\_EXISTS     \\
  0x03 & PFX\_ERR\_TRANSFER\_TOO\_BIG         \\
  0x04 & PFX\_ERR\_TRANSFER\_INVALID          \\
  0x05 & PFX\_ERR\_TRANSFER\_FILE\_NOT\_FOUND \\
  0x06 & PFX\_ERR\_TRANSFER\_CRC\_MISMATCH    \\
  0x07 & PFX\_ERR\_TRANSFER\_BUSY\_WAIT       \\
  0x08 & PFX\_ERR\_TRANSFER\_LUT\_FULL        \\
  0xFF & PFX\_ERR\_TRANSFER\_ERROR            \\
  0x80 & PFX\_ERR\_UPGRADE\_FAIL              \\
  0x0A & PFX\_ERR\_TRAP\_BROWNOUT\_RST        \\
  0x10 & PFX\_ERR\_TRAP\_CONFLICT             \\
  0x20 & PFX\_ERR\_TRAP\_ILLEGAL\_OPCODE      \\
  0x40 & PFX\_ERR\_TRAP\_CONFIG\_MISMATCH     \\
  \hline
\end{tabular}
